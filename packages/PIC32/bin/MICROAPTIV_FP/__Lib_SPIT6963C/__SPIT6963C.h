...
extern atomic sfr sbit        SPI_T6963C_CntlWr;                 // WR write bit mask
extern atomic sfr sbit        SPI_T6963C_CntlRd;                 // RD read bit mask
extern atomic sfr sbit        SPI_T6963C_CntlCd;                 // CD command/data bit mask
extern atomic sfr sbit        SPI_T6963C_CntlRst;                // RST reset bit mask
