...
sbit TFT_BLED_Direction at TRISD1_bit;
sbit TFT_BLED at LATD1_bit;
sbit TFT_CS_Direction at TRISF8_bit;
sbit TFT_CS at LATF8_bit;
...
sbit TFT_RS_Direction at TRISG6_bit;
sbit TFT_RS at LATG6_bit;
sbit TFT_RST_Direction at TRISB15_bit;
sbit TFT_RST at LATB15_bit;
...
static void TFT_SSD1963_Set_PCLK_400MHz(){
  ...
  TFT_Set_Index_Ptr(0xe6);                //SET PCLK freq=200MHz  pixel clock frequency
...
void Init_MCU()
{
    ...
    // Wait for data line to be available.
    LATA3_bit = 1;
        while (PORTA.B3 == 0) {
            LATA2_bit = 0;
            Delay_us(10);
    ...
    // Initialize I2C for touch screen purposes.
    I2C2_Init(400000);
...
void main() {
    TFT_Init_SSD1963_Board_43_8bit(480, 272);
