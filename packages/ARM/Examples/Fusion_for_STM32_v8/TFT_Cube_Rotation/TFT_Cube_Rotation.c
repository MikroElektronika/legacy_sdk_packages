 ...
 * Test configuration:
     ...
     Dev.Board:       Fusion_for_STM32_Board_4_Capacitive
...
static void TFT_SSD1963_Set_PCLK_350MHz(){

  TFT_RST = 1;
  TFT_CS = 0;
  TFT_Set_Index_Ptr(0x28);                //SET display off

  TFT_Set_Index_Ptr(0xe6);                //SET PCLK freq=350MHz  ; pixel clock frequency
  TFT_Write_Command_Ptr(0x05);
  TFT_Write_Command_Ptr(0x57);
