...
#define PCR_AESH  (((unsigned int)(PCR2_AESH_BPOS) << 8) + (unsigned int)(PCR2_SLP_EN_REG_OFS & 0xFFu))
#define MAKE_WORD(b0,b1,b2,b3) ((unsigned long)(b0) + ((unsigned long)(b1) << 8) + ((unsigned long)(b2) << 16) + ((unsigned long)(b3) << 24))
